...
// createAsyncThunk<PayloadResponse, ThunkArgument, { state: RootState }>("slice/typeName", payloadCreator);

// export const checkoutCart = createAsyncThunk<{ success: boolean }, undefined, { state: RootState }>(
//   "cart/checkout",
//   async (_, thunkAPI) => {
